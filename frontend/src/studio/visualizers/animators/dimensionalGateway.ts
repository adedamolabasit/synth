...
export const animateDimensionalGateway = (
  ...
  objects.forEach((obj) => {
    ...
    const dimensionalParticles = obj.userData
      .dimensionalParticles as THREE.Points;
    ...
    const particleGeometry =
      dimensionalParticles.geometry as THREE.BufferGeometry;
    ...
    if (beatInfo?.isBeat) {
      ...
      const gatewayMaterial =
        mainGateway.material as THREE.MeshPhysicalMaterial;
