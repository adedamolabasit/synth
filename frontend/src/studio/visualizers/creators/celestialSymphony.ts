...
export const createCelestialSymphonyVisualizer = (
  ...
  const planetTypes = [
    { size: 1.2, color: 0xff6b6b, rings: true },
    { size: 0.8, color: 0x4ecdc4, rings: false },
    { size: 1.0, color: 0x45b7d1, rings: true },
    { size: 0.6, color: 0xffa500, rings: false },
    { size: 0.9, color: 0x96ceb4, rings: true },
    { size: 1.1, color: 0xfeca57, rings: false },
    { size: 0.7, color: 0xff9ff3, rings: true },
    { size: 1.3, color: 0x54a0ff, rings: false },
  ];
